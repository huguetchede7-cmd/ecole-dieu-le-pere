...
@section('page_title', 'Gestion des Reçus')
...
<div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 24px;">
    <h2 style="font-size: 16px; color: #333;">Liste des reçus</h2>
    <a href="/admin/recus/create" style="background: #1a73e8; color: white; padding: 10px 20px; border-radius: 8px; text-decoration: none; font-size: 14px;">
        + Générer un reçu
    </a>
</div>
    ...
    <table style="width: 100%; border-collapse: collapse;">
        <thead>
            <tr style="background: #f8f9fa;">
                ...
                <th style="padding: 14px 20px; text-align: left; font-size: 13px; color: #666;">N° Reçu</th>
        ...
        <tbody>
            ...
            <tr style="border-top: 1px solid #f0f0f0;">
                ...
                <td style="padding: 14px 20px;">
                    ...
                    <form method="POST" action="/admin/recus/{{ $recu->id }}" style="display: inline;">
                        @csrf
                        @method('DELETE')
                        <button type="submit" onclick="return confirm('Supprimer ce reçu ?')"
