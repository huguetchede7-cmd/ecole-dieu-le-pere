...
<form method="POST" action="/admin/types-frais">
    ...
    <div style="margin-bottom: 20px;">
        ...
        <input type="text" name="libelle" value="{{ old('libelle') }}" placeholder="ex: Inscription, Mensualité, Cantine" required
    ...
    <div style="margin-bottom: 20px;">
        ...
        <input type="number" name="montant" value="{{ old('montant') }}" min="0" step="0.01" required
            style="width: 100%; padding: 10px 14px; border: 1px solid #ddd; border-radius: 8px; font-size: 14px; outline: none;">
    </div>
